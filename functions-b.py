...
#Question 2
# add_numbers naam ka function likhiye jo do numbers ko arguments ke tarah le aur fir unka sum print karta hai. Agar main uss function ko 56 aur 12 dunga toh woh aise output dega:
'''
---------------
68
---------------
...
#Question 3
# add_numbers_list naam ka function likhiye jo do integers ki 2 lists leta ho aur fir same position wale integers ka sum print karta ho. woh integers ka sum aapka pichla function add_numbers use karke karega.
...
# Yahan tumhe and operator aur if statement ka use karna padega. Agar bhul gaye ho toh wapas jake padh sakte hain
...
#Question 5
# jo aapne add_numers_list wala function likha hai usko yahan copy-paste karein.
# jaise aapne list ke same index number wale dono numbers ko add_numers mein argument deke add kiya tha ussi tareeke
# se same index numbers wale list items ko check_numbers ko arguments deke yeh print karvao ki dono even hai ya nahi=
# isko karne ke liye aap jo do list ke same index wale numbers add_numbers ko argument mein dete ho, wahi do numbers check_numbers ko bhi de sakte ho.
