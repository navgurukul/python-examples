...
# numbers_list = [9, 8, 7, 6, 5, 4, 3, 2, 1]
...
# - 2 humein 1 + 1 kar ke milega.
# - 3 humein 2 + 1 kar ke milega
# - 5 humein 3 + 2 kar ke milega
# - 8 humein 5 + 3 kar ke milega
...
# Yeh list hai lekin aapka code kisi bhi list pe kaam karna chaiye. Aur list ki length se bhi farak nahi padna chaiye:
numbers_list = [65, 134, 23245, 311, 213, 953, 32, 674, 21, 3653]
