...
#
# ----------------------------------------
# <question text e.g - Python kya hai?>
# ----------------------------------------
# 
# yeh dashes bhi print karne hai
...
# ----------------------------------------
# 
# Iska Answer (1, 2, 3 and 4 mei kariye)
# <yaha par user ka input le>
#
...
# total_length variable ko print karo
...
# Aap apni questions_list ko iterate karo
# Uppar wale question mei change karo ki agar question ki length 15 se kam hai toh print karein
# "Question chota hai"
# Nahi toh likho "Question kaafi lamba hai"
