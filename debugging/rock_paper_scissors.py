#  Yeh rock paper scissors game ka program hai.
#  Iss game ko aap computer ke against kheloge. Iss game ke 3 rules hai 
...
#  Firr, oopar diye gaye rules ke hisab se result aayega.
# Jaise,
