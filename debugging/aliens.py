...
#  Iss game mein aap ek alien se fight karoge.
#  Game mei alien ka stamina 10 se shuru hoga.
#  Aapko uska stamina khatam karna hai yaani ki 0 karna hai.
#  Aisa karne ke liye aap alien ke against in 4 options mei se koi option use kar sakte ho.
#  1.Hit 
#  2.attack 
#  3.fight 
#  4.run

#  Hit aur attack karne se alien ka stamina 0-9 ke beech kisse random number se kam hoga.
#  Har bar stamina kam karne par report() se report aayegi jo alien ke stamina ke hisab se uski condition bateygi. 
