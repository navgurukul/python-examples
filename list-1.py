# Iss example mei hum LISTS ko samjhenge
...
# LIST ke andar aap kuch bhi OBJECT rakh sakte hai, jaise
...
# ravi ke board mei marks ki list
...
# jaise pichle saat din ke temperatures ki LIST
