...
# Iske liye aapko lifeline_counter use karna padega jisko aap har baar use karne par 1 se ghata doge
...
# Agar user lifeline_counter 0 hone ke baad bhi lifeline likhega toh, aap bologe ki
# "Aap apni saari lifelines use kar chuke hai.\n"
# Aur game normally chalaoge
